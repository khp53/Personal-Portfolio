...
if(isset($update))
{
mysqli_query($con,"update paintings set painting_no='$rno',type='$type',price='$price',details='$details' where painting_id='$id' ");
...
<table class="table table-bordered">
	...
	<tr>	
		<th>Painting No</th>
		<td><input type="text"  name="rno" value="<?php echo $res['painting_no']; ?>"  class="form-control"/>
		</td>
	</tr>
	...
	<tr>
		<td colspan="2">
			<input type="submit" class="btn btn-primary" value="Update Painting Details" name="update"/>
		</td>
	</tr>
</table> 
</form>